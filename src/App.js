...
function App() {
  ...
  //run useEffect once when the app is loaded
  useEffect(()=>{
    getEngines();
  },[])
    ...
    <div className="App">
      ...
      <section className="chatbox">
        ...
        <div className="chat-input-holder">
          ...
          <input row="1" value={input} onChange={(e)=>setInput(e.target.value)} className="chat-input-textarea" placeholder="Type Your Query Here">  
          </input>
          </form>
        </div>
